...
import de.hdodenhof.circleimageview.CircleImageView;
 ...
 public class ProfileActivity extends AppCompatActivity {
    ...
    private TextView type,name,email,diNumber,phoneNumber,bloodGroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diNumber = findViewById(R.id.idNumber);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    diNumber.setText(snapshot.child("idNumber").getValue().toString());
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ProfileActivity.this,MainRanaActivity.class);

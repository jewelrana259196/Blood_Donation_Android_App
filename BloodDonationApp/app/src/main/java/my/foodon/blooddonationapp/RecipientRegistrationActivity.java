                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()) {
                                ...
                                if (resultUri != null) {
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if (task.isSuccessful()) {
                                                                    Toast.makeText(RecipientRegistrationActivity.this, "Image url addSuccessful", Toast.LENGTH_SHORT).show();
                                                                } else {
                                                                    Toast.makeText(RecipientRegistrationActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                    ...
                                    Intent intent = new Intent(RecipientRegistrationActivity.this, MainRanaActivity.class);
                                    startActivity(intent);
                                    finish();
                                    loader.dismiss();
                                }
